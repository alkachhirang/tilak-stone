...
const GetInspired = () => {
    return (
      <div className="xl:pt-[140px] relative z-0">
        <div className="max-w-[1920px] max-h-full sm:max-h-[862px] lg:max-h-[944px] overflow-hidden">
          ...
          <div className="sm:flex overflow-hidden hidden justify-center gap-[14px] sm:gap-6 -mt-[240px]">
            <div className="flex-col flex gap-5 sm:gap-6">
            ...
            <div className="flex-col mt-24 lg:mt-36 pt-2 flex gap-5 sm:gap-6">
              <div className="rounded-2xl overflow-hidden shadow-inspire-img-shadow">
                <img
                  className="lg:max-w-[267px] sm:max-w-[248px] sm:min-h-[305px] max-w-[174px] hover:scale-110 duration-300"
                  src={shelf}
            ...
            <div className="flex-col  mt-60 pt-4 lg:mt-72 lg:pt-6 flex gap-5 sm:gap-6">
              <div className="rounded-2xl overflow-hidden shadow-inspire-img-shadow">
                <img
                  className="lg:max-w-[267px] sm:max-w-[248px] sm:min-h-[305px] max-w-[174px] hover:scale-110 duration-300"
                  src={bull}
            ...
            <div className="flex-col lg:mt-36 mt-24 pt-2 flex gap-5 sm:gap-6">
              <div className="rounded-2xl overflow-hidden shadow-inspire-img-shadow">
                <img
                  className="lg:max-w-[267px] sm:max-w-[248px] sm:min-h-[305px] max-w-[174px] hover:scale-110 duration-300"
                  src={krishan}
